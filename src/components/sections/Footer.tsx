...
import { businessName, address, phoneNumber, phoneLink, navLinks, getWhatsAppUrl } from "@/data";
import { termsOfServiceContent, privacyPolicyContent } from "@/data/legal";
          ...
          <div className="mt-10 pt-6 border-t border-metal-800/50 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="text-metal-500 hover:text-metal-300 text-xs transition-colors"
              >
                Terms of Service
              </button>
              <button
      ...
      >
        {termsOfServiceContent.sections.map((section) => (
          <div key={section.heading}>
            ...
            <p className="text-metal-400 whitespace-pre-line">{section.body}</p>
          </div>
        ))}
      </LegalModal>
